	...
	<div class="main">
		...
		<section class="dashboard">
			...
			<div class="box-container">
				...
				<div class="box">
					<a href="view_posts.php" style="color: black">
						<?php
				...
				<div class="box">
					<a href="view_activated_posts.php" style="color: black">
						<?php
						...
						<p>active posts</p>
						<a href="view_activated_posts.php" class="btn">see posts</a>
					</a>
				</div>

				<div class="box">
					<a href="view_deactivated_posts.php" style="color: black">
						<?php
						...
						<p>deactive posts</p>
						<a href="view_deactivated_posts.php" class="btn">see posts</a>
					</a>
				</div>
				<div class="box">
					<?php
				...
				<div class="box">
					<a href="view_cancelled_orders.php" style="color: black">
						<?php
						$select_canceled_order = $conn->prepare("SELECT * FROM `orders` WHERE status = ?");
						$select_canceled_order->execute(['Cancelled']);
						$total_canceled_order = $select_canceled_order->rowCount();
						?>
						<h3><?= $total_canceled_order; ?></h3>
						<p>total canceled order</p>
						<a href="view_cancelled_orders.php" class="btn">see orders</a>
					</a>
				</div>
				<div class="box">
					<a href="view_active_orders.php" style="color: black">
						<?php
						...
						<a href="view_active_orders.php" class="btn">see orders</a>
					</a>
				</div>
				<div class="box">
					<a href="admin_order.php" style="color: black">
						<?php
				...
				<div class="box">
					<a href="view_completed_orders.php" style="color: black">
						<?php
						$select_complete_order = $conn->prepare("SELECT * FROM `orders` WHERE status = ?");
						$select_complete_order->execute(['Completed']);
						$total_complete_order = $select_complete_order->rowCount();
						?>
						<h3><?= $total_complete_order; ?></h3>
						<p>total completed orders</p>
						<a href="view_completed_orders.php" class="btn">see orders</a>
					</a>
				</div>
				<div class="box">
					<a href="add_category.php" style="color: black">
						<?php
						$select_complete_order = $conn->prepare("SELECT * FROM `categories`");
						$select_complete_order->execute();
						$total_complete_order = $select_complete_order->rowCount();
						?>
						<h3><?= $total_complete_order; ?></h3>
