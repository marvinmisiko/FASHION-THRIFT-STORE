...
<head>
	...
	<title>Store - Details Page</title>
</head>
			...
			?>
						<form method="post">
							<div class="image-container">
								<img src="admin_panel/image/<?php echo $fetch_products['image']; ?>" style="border-radius: 20px">
							</div>
							<div class="detail">
								<div class="price">KES <?php echo $fetch_products['price']; ?>/-</div>
