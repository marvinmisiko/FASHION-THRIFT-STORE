			...
			<div class="box-container">
				...
				?>
							<form method="post" action="" class="box">
								...
								<img src="admin_panel/image/<?= $fetch_products['image']; ?>">
								<div class="button">
									<button type="submit" name="add_to_cart"><img src="icons/cart.png" style="height: 25px; margin-left: 5px; " /></button>
									<a href="view_page.php?pid=<?php echo $fetch_products['id']; ?>"><img src="icons/show.png" style="height: 25px; margin-left: 5px;" /></a>
									<button type="submit" name="delete_item" onclick="return confirm('delete this item');"><img src="icons/x.png" style="height: 25px; margin-left: 5px;" /></i></button>
								</div>
								<h3 class="name"><?= $fetch_products['name']; ?></h3>
								<input type="hidden" name="product_id" value="<?= $fetch_products['id']; ?>">
								<div class="flex">
									<p class="price">price KES <?= $fetch_products['price']; ?>/-</p>
								</div>
