...
if (isset($_POST['search_btn'])) {
	...
	$search_query->execute(['In Progress', '%' . $search . '%']);
...
<body>
	...
	<div class="main">
		<div class="banner">
			<h1>total active orders</h1>
		</div>
		<div class="title2">
			<a href="dashboard.php">home </a><span>/ active orders</span>
		</div>
		<section class="order-container">
										...
										<div class="btn-container">
											<form method="post">
												...
												<select name="update_payment">
													<option disabled selected><?php echo $fetch_search['status']; ?></option>
			...
			<h1 class="heading">total active orders</h1>
			<div class="box-container">
				<?php
