...
if (isset($_POST['search_btn'])) {
	...
	$search_query->execute(['Completed', '%' . $search . '%']);
...
<body>
	...
	<div class="main">
		<div class="banner">
			<h1>total complete orders</h1>
		</div>
		<div class="title2">
			<a href="dashboard.php">home </a><span>/ complete orders</span>
		</div>
		<section class="order-container">
			...
			<h1 class="heading">total completed orders</h1>
			<div class="box-container">
				<?php
