...
if (isset($_POST['search_btn'])) {
	...
	$search_query = $conn->prepare("SELECT * FROM `orders` WHERE name LIKE ?");
...
<body>
	...
	<div class="main">
		...
		<div class="title2">
			<a href="dashboard.php">home </a><span>/ total order</span>
		</div>
				...
				?>
									<div class="box">
										...
										<div class="btn-container">
											<?php if ($fetch_search['status'] == 'in progress') { ?>
												<form method="post">
													<input type="hidden" name="order_id" value="<?php echo $fetch_orders['id']; ?>">
													<select name="update_payment">
														<option disabled selected><?php echo $fetch_search['payment_status']; ?></option>
				...
				?>
								<div class="box">
									<div class="status" style="color: <?php if ($fetch_orders['status'] == 'in progress') {
																			...
																			echo "coral";
																		} ?>;"><?= $fetch_orders['status'] ==  "in progress" ? "active" : $fetch_orders['status'] ?></div>
									<div class="detail">
									...
									<?php if ($fetch_orders['status'] == 'in progress') { ?>
										<form method="post">
											<input type="hidden" name="order_id" value="<?php echo $fetch_orders['id']; ?>">
											<select name="update_payment">
